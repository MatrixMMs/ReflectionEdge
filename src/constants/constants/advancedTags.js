...
exports.getPatternBasedTags = exports.getMarketConditionBasedTags = exports.getTimeBasedTags = exports.getAutoSuggestTags = exports.getTagsBySubcategory = exports.getTagsByCategory = exports.getGroupById = exports.getTagById = exports.ADVANCED_TAGS = exports.ADVANCED_SUBJECTIVE_TAGS = exports.ADVANCED_OBJECTIVE_TAGS = exports.ADVANCED_TAG_COLORS = void 0;
// Color palette for the advanced tagging system
exports.ADVANCED_TAG_COLORS = {
    objective: {
        macro: '#3B82F6', // Blue
        time: '#10B981', // Green
...
exports.ADVANCED_OBJECTIVE_TAGS = [
    // 1. Macro Environment
    {
        ...
        subtags: [
            {
                id: 'pre_fomc_drift',
                name: 'Pre-FOMC Drift',
                color: exports.ADVANCED_TAG_COLORS.objective.macro,
        ...
        subtags: [
            {
                id: 'globex_session',
                name: 'Globex Session',
                color: exports.ADVANCED_TAG_COLORS.objective.time,
        ...
        subtags: [
            {
                id: 'inside_value',
                name: 'Inside Value',
                color: exports.ADVANCED_TAG_COLORS.objective.structure,
        ...
        subtags: [
            {
                ...
                color: exports.ADVANCED_TAG_COLORS.objective.orderflow,
                groupId: 'order_flow',
        ...
        subtags: [
            {
                id: 'iceberg_orders',
                name: 'Iceberg Orders',
                color: exports.ADVANCED_TAG_COLORS.objective.liquidity,
...
exports.ADVANCED_SUBJECTIVE_TAGS = [
        ...
        subtags: [
            {
                id: 'calm_focused',
                name: 'Calm & Focused',
                color: exports.ADVANCED_TAG_COLORS.subjective.mental,
        ...
        subtags: [
            {
                ...
                color: exports.ADVANCED_TAG_COLORS.subjective.emotional,
        ...
        subtags: [
            {
                ...
                color: exports.ADVANCED_TAG_COLORS.subjective.execution,
...
exports.ADVANCED_TAGS = __spreadArray(__spreadArray([], exports.ADVANCED_OBJECTIVE_TAGS, true), exports.ADVANCED_SUBJECTIVE_TAGS, true);
// Helper functions
var getTagById = function (tagId) {
    for (var _i = 0, ADVANCED_TAGS_1 = exports.ADVANCED_TAGS; _i < ADVANCED_TAGS_1.length; _i++) {
        var group = ADVANCED_TAGS_1[_i];
        var tag = group.subtags.find(function (t) { return t.id === tagId; });
        if (tag)
            return tag;
    }
    return null;
...
var getGroupById = function (groupId) {
    return exports.ADVANCED_TAGS.find(function (g) { return g.id === groupId; }) || null;
};
exports.getGroupById = getGroupById;
var getTagsByCategory = function (category) {
    return exports.ADVANCED_TAGS.filter(function (g) { return g.category === category; });
};
exports.getTagsByCategory = getTagsByCategory;
var getTagsBySubcategory = function (subcategory) {
    return exports.ADVANCED_TAGS.filter(function (g) { return g.subcategory === subcategory; });
};
exports.getTagsBySubcategory = getTagsBySubcategory;
var getAutoSuggestTags = function () {
    var autoSuggestGroups = exports.ADVANCED_TAGS.filter(function (g) { return g.autoSuggest; });
    return autoSuggestGroups.flatMap(function (g) { return g.subtags; });
};
exports.getAutoSuggestTags = getAutoSuggestTags;
var getTimeBasedTags = function () {
    return exports.ADVANCED_TAGS.flatMap(function (g) { return g.subtags.filter(function (t) { return t.timeBased; }); });
};
exports.getTimeBasedTags = getTimeBasedTags;
var getMarketConditionBasedTags = function () {
    return exports.ADVANCED_TAGS.flatMap(function (g) { return g.subtags.filter(function (t) { return t.marketConditionBased; }); });
};
exports.getMarketConditionBasedTags = getMarketConditionBasedTags;
var getPatternBasedTags = function () {
    return exports.ADVANCED_TAGS.flatMap(function (g) { return g.subtags.filter(function (t) { return t.patternBased; }); });
};
exports.getPatternBasedTags = getPatternBasedTags;
